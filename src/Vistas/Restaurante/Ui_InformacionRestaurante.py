...
"}")
        ...
        Ui_InformacionRestaurante.setTabOrder(self.txtNombreRestaurante, self.txtRuc)
        Ui_InformacionRestaurante.setTabOrder(self.txtRuc, self.txtRazonSocial)
        Ui_InformacionRestaurante.setTabOrder(self.txtRazonSocial, self.txtDireccion)
        Ui_InformacionRestaurante.setTabOrder(self.txtDireccion, self.txtEmail)
        Ui_InformacionRestaurante.setTabOrder(self.txtEmail, self.txtTelefono)
        Ui_InformacionRestaurante.setTabOrder(self.txtTelefono, self.btnGuardarCambios)
